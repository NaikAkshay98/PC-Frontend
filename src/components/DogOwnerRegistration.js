...
const DogOwnerRegistration = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    const userData = {
      firstName, // Removed the "name" field since it's not in your DTO
      lastName,
      email,
    ...
    fetch('https://pawsomecare-backend-afa4879f8915.herokuapp.com/api/dogowners/register', { // Updated endpoint to match your REST structure
      method: 'POST',
      headers: {
    ...
    .then(data => {
      ...
      history.push('/DogOwnerHomePage'); // Use the actual path to the dog owner home page
